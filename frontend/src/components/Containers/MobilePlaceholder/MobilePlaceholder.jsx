...
import Classes from '../MobilePlaceholder/MobilePlaceholder.module.css'

export const MobilePlaceholder = ({ image }) => {
	return (
		<div className={`position-relative ${Classes['mobile-container']}`}>
			<div className={`position-absolute ${Classes['mobile-div-1']}`}>

				</div>
			<div className={`position-absolute ${Classes['mobile-dic-2']}`}>
				<img
					src={image}
					alt="mobile"
			...
			<svg
				viewBox="0 0 366 729"
				aria-hidden="true"
				className={`position-absolute ${Classes['mobile-svg']}`}
			>
				<path
					fill="#F2F2F2"
					fillRule="evenodd"
